# Aptos Indexer Processor SDK Changelog

All notable changes to theSDK will be captured in this file. This changelog is written by hand for now. It adheres to the format set out by [Keep a Changelog](https://keepachangelog.com/en/1.0.0/).
...
- Updated to Rust 1.93.1 and upgraded most dependencies.
